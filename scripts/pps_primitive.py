...
#             robot_coef = [0] * len(self.keypoints[0])
#
...
#             obstacle_coef = [0.1] * len(self.keypoints[1])
#
#         print ('COEFFICIENTS GENERATION')  # WIP
#         print('robot_coef {}'.format(robot_coef))  # WIP
#         print('obstacle_coef {}'.format(obstacle_coef))   # WIP
...
#                 print('transform for {}: {}'.format(keypoint, transform))
...
#         print('incursion diffmat {}'.format(diff_mat))
#
